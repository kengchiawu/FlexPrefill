...
from flex_prefill.ops.headwise_attention import headwise_attention
...
def llama_attn_forward_Headwise(
    ...
    **kwargs,
    ...
    attn_output = headwise_attention(
        query_states,
        key_states,
        value_states,
        gamma=self.config.headwise_gamma,
        block_size=self.config.block_size,
        min_budget=getattr(self.config, "prefill_min_budget", None),
        max_budget=getattr(self.config, "prefill_max_budget", None),
